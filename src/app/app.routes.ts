...
import { ToDoListComponent } from './apps/exames/exames.component';
...
export const routes: Routes = [
    {
        ...
        resolve: {
            cache: FinanceiroCacheResolver
        },
        children: [
            {path: 'extratos', component: ExtratoComponent},
            {path: 'cadastros', component: FinanceiroCadastroMenuComponent},
            {path: 'contas', component: FinanceiroCadastroContaComponent},
